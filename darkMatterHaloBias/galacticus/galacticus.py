...
c_lib.darkMatterProfileDMOHeatedMonotonicL.argtypes = [ c_int, c_void_p, c_int, c_void_p, c_int, c_void_p, c_int ]
...
c_lib.correlationFunctionTwoPointPowerSpectrumTransformL.restype  = c_void_p
c_lib.correlationFunctionTwoPointPowerSpectrumTransformL.argtypes = [  ]
c_lib.correlationFunctionTwoPointCorrelationL.restype  = c_double
c_lib.correlationFunctionTwoPointCorrelationL.argtypes = [ c_void_p, c_int, c_double, c_double ]
c_lib.correlationFunctionTwoPointCorrelationVolumeAveragedL.restype  = c_double
c_lib.correlationFunctionTwoPointCorrelationVolumeAveragedL.argtypes = [ c_void_p, c_int, c_double, c_double ]
c_lib.correlationFunctionTwoPointDestructorL.argtypes = [ c_void_p, c_int ]
...
c_lib.darkMatterHaloBiasPressSchechterL.restype  = c_void_p
c_lib.darkMatterHaloBiasPressSchechterL.argtypes = [ c_void_p, c_int, c_void_p, c_int ]
c_lib.darkMatterHaloBiasSheth2001L.restype  = c_void_p
c_lib.darkMatterHaloBiasSheth2001L.argtypes = [ c_void_p, c_int, c_void_p, c_int ]
c_lib.darkMatterHaloBiasTinker2005L.restype  = c_void_p
c_lib.darkMatterHaloBiasTinker2005L.argtypes = [ c_void_p, c_int, c_void_p, c_int ]
c_lib.darkMatterHaloBiasTinker2010L.restype  = c_void_p
c_lib.darkMatterHaloBiasTinker2010L.argtypes = [ c_void_p, c_int, c_void_p, c_int, c_void_p, c_int ]
c_lib.darkMatterHaloBiasBiasByMassL.restype  = c_double
c_lib.darkMatterHaloBiasBiasByMassL.argtypes = [ c_void_p, c_int, c_double, c_double ]
c_lib.darkMatterHaloBiasBiasByNodeL.restype  = c_double
c_lib.darkMatterHaloBiasBiasByNodeL.argtypes = [ c_void_p, c_int, c_void_p ]
c_lib.darkMatterHaloBiasDestructorL.argtypes = [ c_void_p, c_int ]
...
c_lib.powerSpectrumStandardL.restype  = c_void_p
c_lib.powerSpectrumStandardL.argtypes = [ c_void_p, c_int, c_void_p, c_int ]
c_lib.powerSpectrumPowerL.restype  = c_double
c_lib.powerSpectrumPowerL.argtypes = [ c_void_p, c_int, c_double, c_double ]
c_lib.powerSpectrumPowerDimensionlessL.restype  = c_double
c_lib.powerSpectrumPowerDimensionlessL.argtypes = [ c_void_p, c_int, c_double, c_double ]
c_lib.powerSpectrumPowerLogarithmicDerivativeL.restype  = c_double
c_lib.powerSpectrumPowerLogarithmicDerivativeL.argtypes = [ c_void_p, c_int, c_double, c_double ]
c_lib.powerSpectrumDestructorL.argtypes = [ c_void_p, c_int ]
c_lib.powerSpectrumNonlinearCosmicEmuL.restype  = c_void_p
c_lib.powerSpectrumNonlinearCosmicEmuL.argtypes = [ c_void_p, c_int, c_void_p, c_int, c_void_p, c_int, c_void_p, c_int ]
c_lib.powerSpectrumNonlinearPeacockDodds1996L.restype  = c_void_p
c_lib.powerSpectrumNonlinearPeacockDodds1996L.argtypes = [ c_void_p, c_int, c_void_p, c_int ]
c_lib.powerSpectrumNonlinearSmith2003L.restype  = c_void_p
c_lib.powerSpectrumNonlinearSmith2003L.argtypes = [ c_bool, c_bool, c_bool, c_void_p, c_int, c_void_p, c_int, c_void_p, c_int ]
c_lib.powerSpectrumNonlinearLinearL.restype  = c_void_p
c_lib.powerSpectrumNonlinearLinearL.argtypes = [ c_void_p, c_int ]
c_lib.powerSpectrumNonlinearValueL.restype  = c_double
c_lib.powerSpectrumNonlinearValueL.argtypes = [ c_void_p, c_int, c_double, c_double ]
c_lib.powerSpectrumNonlinearDestructorL.argtypes = [ c_void_p, c_int ]
...
class correlationFunctionTwoPoint:
    ...
    # Destructor
    def __del__(self):
        c_lib.correlationFunctionTwoPointDestructorL(self._glcObj,self._classID)

    def correlationVolumeAveraged(self,separation,time):
        return c_lib.correlationFunctionTwoPointCorrelationVolumeAveragedL(self._glcObj,self._classID,separation,time)

    def correlation(self,separation,time):
        return c_lib.correlationFunctionTwoPointCorrelationL(self._glcObj,self._classID,separation,time)
...
class darkMatterHaloBias:
    ...
    # Destructor
    def __del__(self):
        c_lib.darkMatterHaloBiasDestructorL(self._glcObj,self._classID)

    def biasByNode(self,node,radius=None):
        if not radius:
            return c_lib.darkMatterHaloBiasBiasByNodeL(self._glcObj,self._classID,node,None)
        elif radius:
            return c_lib.darkMatterHaloBiasBiasByNodeL(self._glcObj,self._classID,node,byref(c_double(radius)))
    

    def biasByMass(self,mass,time,radius=None):
        if not radius:
            return c_lib.darkMatterHaloBiasBiasByMassL(self._glcObj,self._classID,mass,time,None)
        elif radius:
            return c_lib.darkMatterHaloBiasBiasByMassL(self._glcObj,self._classID,mass,time,byref(c_double(radius)))
...
class powerSpectrumNonlinear:
    ...
    # Destructor
    def __del__(self):
        c_lib.powerSpectrumNonlinearDestructorL(self._glcObj,self._classID)

    def value(self,wavenumber,time):
        return c_lib.powerSpectrumNonlinearValueL(self._glcObj,self._classID,wavenumber,time)
...
class powerSpectrum:
    ...
    # Destructor
    def __del__(self):
        c_lib.powerSpectrumDestructorL(self._glcObj,self._classID)

    def powerLogarithmicDerivative(self,wavenumber,time):
        return c_lib.powerSpectrumPowerLogarithmicDerivativeL(self._glcObj,self._classID,wavenumber,time)

    def powerDimensionless(self,wavenumber,time):
        return c_lib.powerSpectrumPowerDimensionlessL(self._glcObj,self._classID,wavenumber,time)

    def power(self,wavenumber,time):
        return c_lib.powerSpectrumPowerL(self._glcObj,self._classID,wavenumber,time)
...
class powerSpectrumStandard(powerSpectrum):

    # Constructor
    def __init__(self,cosmologicalMassVariance_,powerSpectrumPrimordialTransferred_):
        # Assign class ID so relevant pointers can be constructed on the Fortran side.
        self._classID = 1
    
        self._glcObj = c_lib.powerSpectrumStandardL(cosmologicalMassVariance_._glcObj,cosmologicalMassVariance_._classID,powerSpectrumPrimordialTransferred_._glcObj,powerSpectrumPrimordialTransferred_._classID)
...
class powerSpectrumNonlinearSmith2003(powerSpectrumNonlinear):

    # Constructor
    def __init__(self,includePeacockCorrection,includeQuasiLinearPower,includeHaloPower,cosmologyParameters_,cosmologyFunctions_,powerSpectrum_):
        # Assign class ID so relevant pointers can be constructed on the Fortran side.
        self._classID = 3
    
        self._glcObj = c_lib.powerSpectrumNonlinearSmith2003L(includePeacockCorrection,includeQuasiLinearPower,includeHaloPower,cosmologyParameters_._glcObj,cosmologyParameters_._classID,cosmologyFunctions_._glcObj,cosmologyFunctions_._classID,powerSpectrum_._glcObj,powerSpectrum_._classID)

class powerSpectrumNonlinearPeacockDodds1996(powerSpectrumNonlinear):

    # Constructor
    def __init__(self,cosmologyFunctions_,powerSpectrum_):
        # Assign class ID so relevant pointers can be constructed on the Fortran side.
        self._classID = 2
    
        self._glcObj = c_lib.powerSpectrumNonlinearPeacockDodds1996L(cosmologyFunctions_._glcObj,cosmologyFunctions_._classID,powerSpectrum_._glcObj,powerSpectrum_._classID)

class powerSpectrumNonlinearLinear(powerSpectrumNonlinear):

    # Constructor
    def __init__(self,powerSpectrum_):
        # Assign class ID so relevant pointers can be constructed on the Fortran side.
        self._classID = 4
    
        self._glcObj = c_lib.powerSpectrumNonlinearLinearL(powerSpectrum_._glcObj,powerSpectrum_._classID)

class powerSpectrumNonlinearCosmicEmu(powerSpectrumNonlinear):

    # Constructor
    def __init__(self,cosmologyFunctions_,cosmologyParameters_,powerSpectrumPrimordial_,cosmologicalMassVariance_):
        # Assign class ID so relevant pointers can be constructed on the Fortran side.
        self._classID = 1
    
        self._glcObj = c_lib.powerSpectrumNonlinearCosmicEmuL(cosmologyFunctions_._glcObj,cosmologyFunctions_._classID,cosmologyParameters_._glcObj,cosmologyParameters_._classID,powerSpectrumPrimordial_._glcObj,powerSpectrumPrimordial_._classID,cosmologicalMassVariance_._glcObj,cosmologicalMassVariance_._classID)
...
class darkMatterProfileDMOHeatedMonotonic(darkMatterProfileDMO):
    ...
    # Constructor
    def __init__(self,nonAnalyticSolver,darkMatterProfileDMO_,darkMatterHaloScale_,darkMatterProfileHeating_):
        # Assign class ID so relevant pointers can be constructed on the Fortran side.
        self._classID = 14
    
        self._glcObj = c_lib.darkMatterProfileDMOHeatedMonotonicL(nonAnalyticSolver,darkMatterProfileDMO_._glcObj,darkMatterProfileDMO_._classID,darkMatterHaloScale_._glcObj,darkMatterHaloScale_._classID,darkMatterProfileHeating_._glcObj,darkMatterProfileHeating_._classID)
...
class darkMatterHaloBiasTinker2010(darkMatterHaloBias):

    # Constructor
    def __init__(self,criticalOverdensity_,cosmologicalMassVariance_,virialDensityContrast_):
        # Assign class ID so relevant pointers can be constructed on the Fortran side.
        self._classID = 4
    
        self._glcObj = c_lib.darkMatterHaloBiasTinker2010L(criticalOverdensity_._glcObj,criticalOverdensity_._classID,cosmologicalMassVariance_._glcObj,cosmologicalMassVariance_._classID,virialDensityContrast_._glcObj,virialDensityContrast_._classID)

class darkMatterHaloBiasTinker2005(darkMatterHaloBias):

    # Constructor
    def __init__(self,darkMatterHaloBias_,correlationFunctionTwoPointNonLinear_):
        # Assign class ID so relevant pointers can be constructed on the Fortran side.
        self._classID = 3
    
        self._glcObj = c_lib.darkMatterHaloBiasTinker2005L(darkMatterHaloBias_._glcObj,darkMatterHaloBias_._classID,correlationFunctionTwoPointNonLinear_._glcObj,correlationFunctionTwoPointNonLinear_._classID)

class darkMatterHaloBiasSheth2001(darkMatterHaloBias):
    ...
    def __init__(self,criticalOverdensity_,cosmologicalMassVariance_):
        ...
        self._glcObj = c_lib.darkMatterHaloBiasSheth2001L(criticalOverdensity_._glcObj,criticalOverdensity_._classID,cosmologicalMassVariance_._glcObj,cosmologicalMassVariance_._classID)

class darkMatterHaloBiasPressSchechter(darkMatterHaloBias):
    ...
    def __init__(self,criticalOverdensity_,cosmologicalMassVariance_):
        ...
        self._glcObj = c_lib.darkMatterHaloBiasPressSchechterL(criticalOverdensity_._glcObj,criticalOverdensity_._classID,cosmologicalMassVariance_._glcObj,cosmologicalMassVariance_._classID)
...
class correlationFunctionTwoPointPowerSpectrumTransform(correlationFunctionTwoPoint):

    # Constructor
    def __init__(self,powerSpectrumNonlinear_=None,powerSpectrum_=None,cosmologyFunctions_=None,linearGrowth_=None):
        # Assign class ID so relevant pointers can be constructed on the Fortran side.
        self._classID = 1
        if powerSpectrumNonlinear_:
            powerSpectrumNonlinear__glcObj =powerSpectrumNonlinear_._glcObj
            powerSpectrumNonlinear__classID=powerSpectrumNonlinear_._classID
        else:
            powerSpectrumNonlinear__glcObj =None
            powerSpectrumNonlinear__classID=None
    
        if powerSpectrum_:
            powerSpectrum__glcObj =powerSpectrum_._glcObj
            powerSpectrum__classID=powerSpectrum_._classID
        else:
            powerSpectrum__glcObj =None
            powerSpectrum__classID=None
        ...
        if linearGrowth_:
            linearGrowth__glcObj =linearGrowth_._glcObj
            linearGrowth__classID=linearGrowth_._classID
        else:
            linearGrowth__glcObj =None
            linearGrowth__classID=None
    
        if not cosmologyFunctions_ and not linearGrowth_ and not powerSpectrumNonlinear_ and not powerSpectrum_:
            self._glcObj = c_lib.correlationFunctionTwoPointPowerSpectrumTransformL(None,None,None,None,None,None,None,None)
        elif not cosmologyFunctions_ and not linearGrowth_ and not powerSpectrumNonlinear_ and powerSpectrum_:
            self._glcObj = c_lib.correlationFunctionTwoPointPowerSpectrumTransformL(None,None,byref(c_void_p(powerSpectrum__glcObj)),byref(c_int(powerSpectrum__classID)),None,None,None,None)
        elif not cosmologyFunctions_ and not linearGrowth_ and powerSpectrumNonlinear_ and not powerSpectrum_:
            self._glcObj = c_lib.correlationFunctionTwoPointPowerSpectrumTransformL(byref(c_void_p(powerSpectrumNonlinear__glcObj)),byref(c_int(powerSpectrumNonlinear__classID)),None,None,None,None,None,None)
        elif not cosmologyFunctions_ and not linearGrowth_ and powerSpectrumNonlinear_ and powerSpectrum_:
            self._glcObj = c_lib.correlationFunctionTwoPointPowerSpectrumTransformL(byref(c_void_p(powerSpectrumNonlinear__glcObj)),byref(c_int(powerSpectrumNonlinear__classID)),byref(c_void_p(powerSpectrum__glcObj)),byref(c_int(powerSpectrum__classID)),None,None,None,None)
        elif not cosmologyFunctions_ and linearGrowth_ and not powerSpectrumNonlinear_ and not powerSpectrum_:
            self._glcObj = c_lib.correlationFunctionTwoPointPowerSpectrumTransformL(None,None,None,None,None,None,byref(c_void_p(linearGrowth__glcObj)),byref(c_int(linearGrowth__classID)))
        elif not cosmologyFunctions_ and linearGrowth_ and not powerSpectrumNonlinear_ and powerSpectrum_:
            self._glcObj = c_lib.correlationFunctionTwoPointPowerSpectrumTransformL(None,None,byref(c_void_p(powerSpectrum__glcObj)),byref(c_int(powerSpectrum__classID)),None,None,byref(c_void_p(linearGrowth__glcObj)),byref(c_int(linearGrowth__classID)))
        elif not cosmologyFunctions_ and linearGrowth_ and powerSpectrumNonlinear_ and not powerSpectrum_:
            self._glcObj = c_lib.correlationFunctionTwoPointPowerSpectrumTransformL(byref(c_void_p(powerSpectrumNonlinear__glcObj)),byref(c_int(powerSpectrumNonlinear__classID)),None,None,None,None,byref(c_void_p(linearGrowth__glcObj)),byref(c_int(linearGrowth__classID)))
        elif not cosmologyFunctions_ and linearGrowth_ and powerSpectrumNonlinear_ and powerSpectrum_:
            self._glcObj = c_lib.correlationFunctionTwoPointPowerSpectrumTransformL(byref(c_void_p(powerSpectrumNonlinear__glcObj)),byref(c_int(powerSpectrumNonlinear__classID)),byref(c_void_p(powerSpectrum__glcObj)),byref(c_int(powerSpectrum__classID)),None,None,byref(c_void_p(linearGrowth__glcObj)),byref(c_int(linearGrowth__classID)))
        elif cosmologyFunctions_ and not linearGrowth_ and not powerSpectrumNonlinear_ and not powerSpectrum_:
            self._glcObj = c_lib.correlationFunctionTwoPointPowerSpectrumTransformL(None,None,None,None,byref(c_void_p(cosmologyFunctions__glcObj)),byref(c_int(cosmologyFunctions__classID)),None,None)
        elif cosmologyFunctions_ and not linearGrowth_ and not powerSpectrumNonlinear_ and powerSpectrum_:
            self._glcObj = c_lib.correlationFunctionTwoPointPowerSpectrumTransformL(None,None,byref(c_void_p(powerSpectrum__glcObj)),byref(c_int(powerSpectrum__classID)),byref(c_void_p(cosmologyFunctions__glcObj)),byref(c_int(cosmologyFunctions__classID)),None,None)
        elif cosmologyFunctions_ and not linearGrowth_ and powerSpectrumNonlinear_ and not powerSpectrum_:
            self._glcObj = c_lib.correlationFunctionTwoPointPowerSpectrumTransformL(byref(c_void_p(powerSpectrumNonlinear__glcObj)),byref(c_int(powerSpectrumNonlinear__classID)),None,None,byref(c_void_p(cosmologyFunctions__glcObj)),byref(c_int(cosmologyFunctions__classID)),None,None)
        elif cosmologyFunctions_ and not linearGrowth_ and powerSpectrumNonlinear_ and powerSpectrum_:
            self._glcObj = c_lib.correlationFunctionTwoPointPowerSpectrumTransformL(byref(c_void_p(powerSpectrumNonlinear__glcObj)),byref(c_int(powerSpectrumNonlinear__classID)),byref(c_void_p(powerSpectrum__glcObj)),byref(c_int(powerSpectrum__classID)),byref(c_void_p(cosmologyFunctions__glcObj)),byref(c_int(cosmologyFunctions__classID)),None,None)
        elif cosmologyFunctions_ and linearGrowth_ and not powerSpectrumNonlinear_ and not powerSpectrum_:
            self._glcObj = c_lib.correlationFunctionTwoPointPowerSpectrumTransformL(None,None,None,None,byref(c_void_p(cosmologyFunctions__glcObj)),byref(c_int(cosmologyFunctions__classID)),byref(c_void_p(linearGrowth__glcObj)),byref(c_int(linearGrowth__classID)))
        elif cosmologyFunctions_ and linearGrowth_ and not powerSpectrumNonlinear_ and powerSpectrum_:
            self._glcObj = c_lib.correlationFunctionTwoPointPowerSpectrumTransformL(None,None,byref(c_void_p(powerSpectrum__glcObj)),byref(c_int(powerSpectrum__classID)),byref(c_void_p(cosmologyFunctions__glcObj)),byref(c_int(cosmologyFunctions__classID)),byref(c_void_p(linearGrowth__glcObj)),byref(c_int(linearGrowth__classID)))
        elif cosmologyFunctions_ and linearGrowth_ and powerSpectrumNonlinear_ and not powerSpectrum_:
            self._glcObj = c_lib.correlationFunctionTwoPointPowerSpectrumTransformL(byref(c_void_p(powerSpectrumNonlinear__glcObj)),byref(c_int(powerSpectrumNonlinear__classID)),None,None,byref(c_void_p(cosmologyFunctions__glcObj)),byref(c_int(cosmologyFunctions__classID)),byref(c_void_p(linearGrowth__glcObj)),byref(c_int(linearGrowth__classID)))
        elif cosmologyFunctions_ and linearGrowth_ and powerSpectrumNonlinear_ and powerSpectrum_:
            self._glcObj = c_lib.correlationFunctionTwoPointPowerSpectrumTransformL(byref(c_void_p(powerSpectrumNonlinear__glcObj)),byref(c_int(powerSpectrumNonlinear__classID)),byref(c_void_p(powerSpectrum__glcObj)),byref(c_int(powerSpectrum__classID)),byref(c_void_p(cosmologyFunctions__glcObj)),byref(c_int(cosmologyFunctions__classID)),byref(c_void_p(linearGrowth__glcObj)),byref(c_int(linearGrowth__classID)))
